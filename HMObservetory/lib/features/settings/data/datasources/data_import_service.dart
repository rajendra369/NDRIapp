...
class DataImportService {
  ...
  Future<Map<String, dynamic>?> pickAndParseExcel() async {
  ...
  Future<void> uploadToFirestore(List<Map<String, dynamic>> data) async {
    final authService = AuthService();
    final collector = authService.currentCollector ?? 'Unknown';
    await uploadRecords(data, collector);
  }
